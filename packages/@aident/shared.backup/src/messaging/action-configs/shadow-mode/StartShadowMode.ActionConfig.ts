...
export class StartShadowMode_ActionConfig extends Base_ActionConfig {
  public static action = ServiceWorkerMessageAction.START_SHADOW_MODE;

  public static description = 'Start Shadow Mode.';
  ...
  public static override async exec(
    ...
    await context.getShadowModeService().startShadowMode();
  }
}

enforceBaseActionConfigStatic(StartShadowMode_ActionConfig);
